      ...
      <section className="pt-24 pb-12 px-6 md:px-20 max-w-5xl mx-auto text-center">
        <FadeIn>
          ...
          <p className="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto mb-16">
            ...
            <br />
            <br />
            ผมเป็นคนชอบคิด วิเคราะห์ และค้นคว้าข้อมูลเกี่ยวกับเรื่องที่สนใจ ทำความเข้าใจสิ่งต่าง ๆ
            <br />
            งานอดิเรกของผมคือการสร้างสรรค์งานวาดและดนตรีดิจิทัล รวมถึงมีความสนใจในการเขียนโปรแกรม
            <br />
