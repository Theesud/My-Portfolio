...
export default function Portfolio() {
  ...
  const computerProjects = [
    { 
      ...
      description: "การพัฒนา Front-End ครั้งแรกในระดับเริ่มต้นด้วย Bootstrap และมีการใส่ลูกเล่น เช่น ภาพเลื่อน วิดีโอ ตัวเล่นเสียง เป็นต้น", 
      tech: "Bootstrap, HTML, CSS", 
      images: ["/image/MyProfile_01.jpg", "/image/MyProfile_02.jpg", "/image/MyProfile_03.jpg", "/image/MyProfile_04.jpg"] 
    },
    { 
      id: 2, 
      title: "MAUI Application", 
      description: "การพัฒนา Application ด้วยโปรแกรม Visual Studio ด้วยภาษา XAML และ C#", 
      tech: ".NET MAUI, XAML, C#, Visual Studio", 
      images: ["/image/MyApp_01.jpg", "/image/MyApp_02.jpg", "/image/MyApp_03.jpg"] 
    },
    { 
      id: 3, 
      title: "SQL", 
      description: "การทดลองเขียน SQL เพื่อทำความเข้าใจการทำงานเบื้องต้น สร้างและเรียกใช้ Database จาก MySQL", 
      tech: "SQL, MySQL", 
      images: ["/image/SQL_01.jpg", "/image/SQL_02.jpg", "/image/SQL_03.jpg", "/image/SQL_04.jpg"] 
    },
    { 
      id: 4, 
      title: "Python Programming", 
      description: "การทดลองเขียน Python และทำโปรแกรมถ่ายภาพ ที่เมื่อแสดงนิ้วแต่ละนิ้วจะทำให้สามารถสร้างเอฟเฟคได้ พร้อมฟีเจอร์การแคปหน้าจอและอัดหน้าจอ",
      tech: "Python, PyCharm", 
      images: ["/image/Python_01.jpg", "/image/Python_02.jpg", "/image/Python_03.jpg"] 
    },
    { 
      id: 5, 
      title: "Unity Game Development", 
      description: "การพัฒนาเกมโดยใช้ Unity โดยสร้างขึ้นเป็นเกมแนว Obby ที่ผู้เล่นจะต้องบังคับตัวละครให้กระโดด ปีนป่าย และหลบหลบหลีกสิ่งกีดขวางต่างๆ เพื่อเดินทางจากจุดเริ่มต้นไปให้ถึงเส้นชัย โดยมีการใส่ฟีเจอร์ต่างๆ เช่น การเก็บกุญแจเพื่อเปิดทางไปต่อ กระสุนปืนใหญ่ที่เมื่อสัมผัสแล้วเกมโอเวอร์ การขึ้นแพลตฟอร์มเคลื่อนที่เพื่อไปอีกฝั่ง และฉากจบ", 
      tech: "C#, Unity", 
      images: ["/image/Unity_01.jpg", "/image/Unity_02.jpg", "/image/Unity_03.jpg", "/image/Unity_04.jpg", "/image/Unity_05.jpg"] 
    }
  ];
  ...
  const creativeProjects = [
    { 
      ...
      description: "การวาดภาพด้วยโปรแกรม Clip Studio Paint มีการวาดเส้นและใช้สี โดยมีแรงบันดาลใจจากแนวญี่ปุ่นและจีน", 
      tech: "Clip Studio Paint", 
      images: ["/image/MyArt_01.jpg", "/image/MyArt_02.jpg", "/image/MyArt_03.jpg", "/image/MyArt_04.jpg"] 
    },
    { 
      id: 2, 
      title: "Music Production", 
      description: "การแต่งและมิกส์ดนตรีด้วยโปรแกรม FL Studio มีพื้นฐานความเข้าใจการเขียนองค์ประกอบเสียง และเครื่องมือต่างๆ โดยมีแรงบันดาลใจจากแนวเพลงในเกมกดจังหวะ", 
      tech: "FL Studio", 
      images: ["/image/MyMusic_01.jpg", "/image/MyMusic_02.jpg", "/image/MyMusic_03.jpg", "/image/MyMusic_04.jpg"] 
    },
    { 
      id: 3, 
      title: "Animated Music Video", 
      description: "การทำ Animation โดยใช้โปรแกรม Adobe After Effects ใช้ทั้งการเคลื่อนไหวของภาพ และการเล่นกล้อง 3D Layering เพื่อให้เกิดการเคลื่อนไหวที่ลื่น โดยใช้เพลงที่ชอบ มีการเขียนเนื้อเรื่อง Storyboard และวาดองค์ประกอบ Animation เอง", 
      tech: "Adobe After Effects",
      images: ["/image/AfterEffect_01.jpg", "/image/AfterEffect_02.jpg", "/image/AfterEffect_03.jpg", "/image/AfterEffect_04.jpg"] 
    },
    { 
      id: 4, 
      title: "3D Blender", 
      description: "การปั้น Object ต่างๆโดยใช้โปรแกรม Blender มีการปั้นรูปทรงเพือนำมาประกอบเป็นฉากและเมือง", 
      tech: "Blender", 
      images: ["/image/Blender_01.jpg", "/image/Blender_02.jpg", "/image/Blender_03.jpg"] 
    },
    { 
      id: 5, 
      title: "3D Maya", 
      description: "การปั้น Character โดยใช้โปรแกรม Maya มีการเริ่มสร้างตั้งแต่หัวจนถึงเท้า และทำ Rigging ใส่กระดูกและการเคลื่อนไหว ทำให้ตัวละครมีชีวิต", 
      tech: "Maya", 
      images: ["/image/Maya_01.jpg", "/image/Maya_02.jpg", "/image/Maya_03.jpg", "/image/Maya_04.jpg"] 
    }
  ];

  const displayedProjects = activeTab === 'computer' ? computerProjects : creativeProjects;
      ...
      <section className="pt-24 pb-12 px-6 md:px-20 max-w-5xl mx-auto text-center">
        <FadeIn>
          ...
          <p className="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto mb-16">
            สวัสดีครับ<br /> ผมนายธีร์สุต ชูชัยวัฒนศักดิ์ ชื่อเล่นเรย์ครับ <br />
            เป็นนักศึกษาปริญญาตรีปี 4 คณะเทคโนโลยีสารสนเทศ
            สาขาเทคโนโลยีมัลติมีเดีย<br /> จากสถาบันเทคโนโลยีไทย-ญี่ปุ่น<br />
            <br />
            ผมเป็นคนชอบคิด วิเคราะห์ และค้นคว้าข้อมูลเกี่ยวกับเรื่องที่สนใจ และทำความเข้าใจสิ่งต่าง ๆ<br />
            งานอดิเรกของผมคือการสร้างสรรค์งานวาดและดนตรีดิจิทัล รวมถึงมีความสนใจในการเขียนโปรแกรม<br />
            มีความชอบในการผสมผสานระหว่างตรรกะของการเขียนโปรแกรมและความคิดสร้างสรรค์<br />
            จึงสนใจพัฒนาทักษะและเพิ่มความชำนาญด้านการพัฒนาเว็บไซต์และซอฟต์แวร์<br />
            <br />
            Portfolio Website นี้พัฒนาโดยใช้ Next.js และ Tailwind CSS<br />
            ขอเชิญเลื่อนชมผลงานด้านคอมพิวเตอร์และงานครีเอทีฟของผมด้านล่างได้เลยครับ
          </p>
        </FadeIn>
                ...
                >
                  ...
                  <div className="w-full md:w-1/2">
                    ...
                    <span className={`inline-block text-sm px-4 py-2 rounded-full font-medium ${
                      activeTab === 'computer' ? 'bg-slate-200 text-slate-800' : 'bg-blue-100 text-blue-800'
                    }`}>
                      {project.tech}
                    </span>
                  </div>
      ...
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        <div className="flex flex-col items-center gap-6 bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <div className="w-full space-y-3 text-center md:text-left">
            <h3 className="text-xl font-semibold text-gray-700 text-center">English Proficiency</h3>
            <p className="text-gray-600 leading-relaxed text-sm md:text-base text-center">
              ผมมีคะแนนสอบ TOEIC โดยสอบเมื่อวันที่ 11 มีนาคม 2025<br />
              โดยแบ่งเป็นส่วนของ Listening 255 คะแนน และ Reading 405 คะแนน<br />
              รวมทั้งสิ้น 660 คะแนน<br />
              <br />
              ผมมีประสบการณ์จากการสื่อสารจริงกับชาวต่างชาติทั้งบนโลกออนไลน์และในชีวิตจริง<br />
              ทำให้ผมมีความสามารถในการใช้ภาษาอังกฤษเพื่อการสื่อสาร ทำงาน การประสานงาน<br />
              และการค้นคว้าหาความรู้จากแหล่งข้อมูลต่างประเทศ
            </p>
          </div>
      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-12">
          ...
          <div className="flex items-center gap-3 text-gray-700 hover:text-red-500 transition">
            ...
            <span className="text-lg">Theesud.Chuchaiwattanasak@gmail.com</span>
          </div>

          {/* Facebook */}
          <a href="https://www.facebook.com/theesud.chuchaiwattanasak/" target="_blank" rel="noopener noreferrer" 
